...
public class 地圖一右鍵盤槍 : MonoBehaviour
{
    //地圖一右鍵盤P2槍模式
    ...
    void Update()
    {
        ...
        //攻擊
        if (Input.GetKeyDown(KeyCode.RightControl) && SaveData.P1攻擊中 == false && 是否拿起吸血鬼 == false && 是否拿起幽靈 == false && 是否拿起大蒜 == false && 是否拿起大蒜藥水 == false && 是否拿起水杯 == false && 是否拿起滿水 == false && 是否拿起鹽巴藥水 == false && 是否拿起鹽巴 == false && 是否拿起石化吸血鬼 == false && 是否拿起石化幽靈 == false)
        {
            Rigidbody clone;
        ...
        /*
        if (Input.GetKeyDown(KeyCode.RightShift) && 是否拿起吸血鬼 == true && 拾取計數器 == 0)
        {
            if (!丟.isPlaying)
            {
                丟.Play();
    ...
    private void OnTriggerStay(Collider col)
    {
        ...
        //大蒜
        if (col.tag == "大蒜箱子" && Input.GetKey(KeyCode.RightShift) && 是否拿起吸血鬼 == false && 拾取計數器 == 1)
        {
            if (!撿.isPlaying)
            {
                撿.Play();
        ...
        if (col.tag == "大蒜" && Input.GetKey(KeyCode.RightShift) && 是否拿起吸血鬼 == false && 拾取計數器 == 1)
        {
            if (!撿.isPlaying)
            {
                撿.Play();
        ...
        //水杯
        if (col.tag == "藥水箱子" && Input.GetKey(KeyCode.RightShift) && 是否拿起吸血鬼 == false && 拾取計數器 == 1)
        {
            if (!撿.isPlaying)
            {
                撿.Play();
        ...
        if (col.tag == "藥水" && Input.GetKey(KeyCode.RightShift) && 是否拿起吸血鬼 == false && 拾取計數器 == 1)
        {
            if (!撿.isPlaying)
            {
                撿.Play();
        ...
        if (col.tag == "滿水" && Input.GetKey(KeyCode.RightShift) && 是否拿起吸血鬼 == false && 拾取計數器 == 1)
        {
            if (!撿.isPlaying)
            {
                撿.Play();
        ...
        //鹽巴
        if (col.tag == "鹽巴箱子" && Input.GetKey(KeyCode.RightShift) && 是否拿起吸血鬼 == false && 拾取計數器 == 1)
        {
            if (!撿.isPlaying)
            {
                撿.Play();
        ...
        if (col.tag == "鹽巴" && Input.GetKey(KeyCode.RightShift) && 是否拿起吸血鬼 == false && 拾取計數器 == 1)
        {
            if (!撿.isPlaying)
            {
                撿.Play();
        ...
        if (col.tag == "鹽巴藥水" && Input.GetKey(KeyCode.RightShift) && 是否拿起吸血鬼 == false && 拾取計數器 == 1)
        {
            if (!撿.isPlaying)
            {
                撿.Play();
        ...
        if (col.tag == "大蒜藥水" && Input.GetKey(KeyCode.RightShift) && 是否拿起吸血鬼 == false && 拾取計數器 == 1)
        {
            if (!撿.isPlaying)
            {
                撿.Play();
        ...
        //祭壇
        if (col.tag == "祭壇" && Input.GetKey(KeyCode.RightShift) && col.GetComponent<祭壇>().顯示吸血鬼 == false && 是否拿起吸血鬼 == true && 拾取計數器 == 0)
        {
            if (!丟.isPlaying)
            {
                丟.Play();
        ...
        if (col.tag == "祭壇" && Input.GetKey(KeyCode.RightShift) && col.GetComponent<祭壇>().顯示幽靈 == false && 是否拿起幽靈 == true && 拾取計數器 == 0)
        {
            if (!丟.isPlaying)
            {
                丟.Play();
