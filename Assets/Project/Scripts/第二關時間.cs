...
public class 第二關時間 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (第二關儲存空間.P1HP == 2 && 第二關儲存空間.P2HP == 2)
        {
            第二關儲存空間.遊戲結束 = true;
            m_min = 0;
            m_seconds = 0;
        ...
        X33數量.text = 第二關儲存空間.實驗體X33分數.ToString() + "/3";
        腦袋數量.text = 第二關儲存空間.腦袋分數.ToString() + "/3";
        熊數量.text = 第二關儲存空間.熊分數.ToString() + "/3";
    ...
    IEnumerator Countdown()
    {
        ...
        yield return new WaitForSeconds(1);
        if (第二關儲存空間.實驗體X33分數 < 3 && 第二關儲存空間.腦袋分數 < 3)
        {
            第二關儲存空間.第二關完成 = false;
            if (!遊戲結束.isPlaying)
            {
        ...
        if (第二關儲存空間.實驗體X33分數 +第二關儲存空間.腦袋分數+第二關儲存空間.熊分數 >= 3&& 第二關儲存空間.實驗體X33分數 + 第二關儲存空間.腦袋分數 + 第二關儲存空間.熊分數<=4)
        {
            第二關儲存空間.第二關完成 = true;
            if (!遊戲成功.isPlaying)
            {
        ...
        if (第二關儲存空間.實驗體X33分數 + 第二關儲存空間.腦袋分數 + 第二關儲存空間.熊分數 >= 5 && 第二關儲存空間.實驗體X33分數 + 第二關儲存空間.腦袋分數 + 第二關儲存空間.熊分數 <= 6)
        {
            第二關儲存空間.第二關完成 = true;
            if (!遊戲成功.isPlaying)
            {
        ...
        if (第二關儲存空間.實驗體X33分數 + 第二關儲存空間.腦袋分數 + 第二關儲存空間.熊分數 >= 7 && 第二關儲存空間.實驗體X33分數 + 第二關儲存空間.腦袋分數 + 第二關儲存空間.熊分數 <= 100)
        {
            第二關儲存空間.第二關完成 = true;
            if (!遊戲成功.isPlaying)
            {
