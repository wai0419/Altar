...
public class HallP1 : MonoBehaviour
{
    //鍵盤控制P1
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.RightShift) && 是否拿起第一關書 == true && 拾取計數器 == 0)
        {
        ...
        if (Input.GetKeyDown(KeyCode.RightShift) && 是否拿起第二關書 == true && 拾取計數器 == 0)
        {
        ...
        if (Input.GetKeyDown(KeyCode.RightShift) && 是否拿起第三關書 == true && 拾取計數器 == 0)
        {
    ...
    private void OnTriggerStay(Collider col)
    {
        ...
        if (col.tag == "第二關書" && Input.GetKey(KeyCode.RightShift) && 拾取計數器 == 1)
        {
            Invoke("D0", 0.1f);
            是否拿起第二關書 = true;
        ...
        if (col.tag == "第三關書" && Input.GetKey(KeyCode.RightShift) && 拾取計數器 == 1)
        {
            Invoke("D0", 0.1f);
            是否拿起第三關書 = true;
        ...
        if (col.tag == "講台" && Input.GetKey(KeyCode.RightControl) && 拾取計數器 == 0 && 是否拿起第一關書 == true && 第二關書放在講台上 != true && 第三關書放在講台上 != true)
        {
            Invoke("D1", 0.1f);
            第一關書放在講台上 = true;
            是否拿起第一關書 = false;
        ...
        if (col.tag == "講台" && Input.GetKey(KeyCode.RightControl) && 拾取計數器 == 0 && 是否拿起第二關書 == true && 第三關書放在講台上 != true && 第一關書放在講台上 != true)
        {
            Invoke("D1", 0.1f);
            第二關書放在講台上 = true;
            是否拿起第二關書 = false;
        ...
        if (col.tag == "講台" && Input.GetKey(KeyCode.RightControl) && 拾取計數器 == 0 && 是否拿起第三關書 == true && 第一關書放在講台上 != true && 第二關書放在講台上 != true)
        {
            Invoke("D1", 0.1f);
            第三關書放在講台上 = true;
            是否拿起第三關書 = false;
        ...
        if (col.tag == "講台" && Input.GetKey(KeyCode.RightShift) && 拾取計數器 == 1 && 第一關書放在講台上 == true)
        {
            Invoke("D0", 0.1f);
            是否拿起第一關書 = true;
            手上第一關書.SetActive(true);
        ...
        if (col.tag == "講台" && Input.GetKey(KeyCode.RightShift) && 拾取計數器 == 1 && 第二關書放在講台上 == true)
        {
            Invoke("D0", 0.1f);
            是否拿起第二關書 = true;
            手上第二關書.SetActive(true);
        ...
        if (col.tag == "講台" && Input.GetKey(KeyCode.RightShift) && 拾取計數器 == 1 && 第三關書放在講台上 == true)
        {
            Invoke("D0", 0.1f);
            是否拿起第三關書 = true;
            手上第三關書.SetActive(true);
