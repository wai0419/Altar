...
public class 手把控制P2 : MonoBehaviour
{
    //手把控制P2
    ...
    void Update()
    {
        ...
        inputVector = new Vector3(Gamepad.all[1].leftStick.x.ReadValue() * Speed, playerBody.velocity.y, Gamepad.all[1].leftStick.y.ReadValue() * Speed);
